...
TI_K3_BOOT_FIRMWARE_NEXT_VERSION = 09.02.00.010
...
TI_K3_BOOT_FIRMWARE_NEXT_INSTALL_TARGET = YES
TI_K3_BOOT_FIRMWARE_NEXT_LICENSE = TI Proprietary
TI_K3_BOOT_FIRMWARE_NEXT_LICENSE_FILES = LICENSE.ti

UBOOT_PRE_BUILD_HOOKS += TI_K3_BOOT_FIRMWARE_NEXT_RDEPEND_CMD

define TI_K3_BOOT_FIRMWARE_NEXT_RDEPEND_CMD
...
define TI_K3_BOOT_FIRMWARE_NEXT_INSTALL_TARGET_CMDS
