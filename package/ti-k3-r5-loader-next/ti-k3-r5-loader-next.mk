...
TI_K3_R5_LOADER_NEXT_DL_SUBDIR = uboot

UBOOT_PRE_BUILD_HOOKS += TI_K3_R5_LOADER_NEXT_RDEPEND_CMD

define TI_K3_R5_LOADER_NEXT_RDEPEND_CMD
	$(MAKE) ti-k3-r5-loader-next -C $(BASE_DIR)
endef
...
TI_K3_R5_LOADER_NEXT_SOURCE = u-boot-$(TI_K3_R5_LOADER_NEXT_VERSION).tar.gz
